...
public class Fichier {
    public static void main(String[]args){ // départ du prog
        try( // ce code pt avoir des erreurs
            ...
            fichier.write("id,titre,auteur,type,page,annee,disponible\n");//entete
            ...
            fichier.write("15,Kribi,Eto'o,Livre,100,2026,true\n");
            fichier.write("16,Yaounde,Eto'o,Livre,-100,2020,true\n");
